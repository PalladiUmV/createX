                ...
                <div className='wrapper'>
                    <div className='about-page'>
                        <div className='about-page__intro'>
                            <div className='about-page__intro-lesft-container'>
                                <h6 className='about-page__subtitle subtitle'>
                                    About us
                                </h6>
                                <h1 className='about-page__title title'>
                                    Createx Online School
                                </h1>
                                <p className='about-page__intro-text-bold'>
                                    Createx Online School is a leader in online
                                    studying. We have lots of courses and
                                    programs from the main market experts.
                                </p>
                                <p className='about-page__intro-text-light'>
                                    We provide relevant approaches to online
                                    learning, internships and employment in the
                                    largest companies in the country. Our
                                    educational programs help you get a new
                                    specialty from scratch. During your studies,
                                    we will help you find a job. Check the
                                    courses and online events that we organise.
                                </p>
                                <div className='about-page__intro-buttons'>
                                    <button className='about-page__intro-button-explore button'>
                                        Explore events
                                    </button>
                                    <button className='about-page__intro-button-browse button_orange'>
                                        Browse courses
                                    </button>
                                </div>
                            </div>
                    ...
                    <div className='our-values'>
                        <h6 className='our-values__subtitle subtitle'>
                            we always stand for
                        </h6>
                        <h1 className='our-values__title title'>
                            Our core values
                        </h1>
                        <div className='our-values__items'>
                            <div className='our-values__item'>
                                <div className='our-values__item-icon'>
                                    <img
                                        src={coreValueStructure}
                                        alt='structure'
                                    />
                                </div>
                                <div className='our-values__item-title'>
                                    Structured Approach
                                </div>
                                <p className='our-values__item-text'>
                                    Aenean urna dictum adipiscing nec, cras
                                    quisque. Nunc in mauris.{' '}
                                </p>
                            </div>
                            <div className='our-values__item'>
                                <div className='our-values__item-icon'>
                                    <img src={coreValueChat} alt='chat' />
                                </div>
                                <div className='our-values__item-title'>
                            ...
                            <div className='our-values__item'>
                                <div className='our-values__item-icon'>
                                    <img src={coreValueTarget} alt='target' />
                                </div>
                                <div className='our-values__item-title'>
                                    Efficiency
                                </div>
                                <div className='our-values__item-text'>
                                    <p>
                                        Viverra scelerisque consequat net.
                            ...
                            <div className='our-values__item'>
                                ...
                                <div className='our-values__item-text'>
                                    <p>
                                        Aute eiusmod dolore dolore deserunt
                                        veniam ad deserunt.{' '}
                                    </p>{' '}
                                </div>
                            </div>
                    ...
                    <div className='our-directions'>
                        <h6 className='our-directions__subtitle subtitle'>
                            our main directions
                        </h6>
                        <h1 className='our-directions__title title'>
                            What do we teach
                        </h1>
                        <div className='our-directions__cards'>
                            {directions.map((item, idx) => {
                                ...
                                return (
                                    <div
                                        key={idx + alt}
                                        className='our-directions__card course'
                                    >
                                        <img
                                        ...
                                        <div className='our-directions__card-content'>
                                            <span
                                                className={`our-directions__spec spec ${specColor}`}
                                            >
                                                {spec}
                                            </span>
                                            ...
                                            <Link
                                                to='/courses'
                                                className='our-directions__card-link-more'
                                            >
                                                Check courses{' '}
                                                <img
                                                    src={arrowRight}
                    ...
                    <div className='studying-process'>
                        <div className='studying-process__left-container'>
                            ...
                            <ul className='studying-process__list'>
                                <li>
                                    <span className='studying-process__list-step'>
                                        step 1
                                    </span>
                                    <div className='studying-process__list-title'>
                                        Watching online video lectures
                                    </div>
                                    <div className='studying-process__list-text'>
                                        Aliquam turpis viverra quam sit interdum
                                        blandit posuere pellentesque. Nisl,
                                ...
                                <li>
                                    ...
                                    <div className='studying-process__list-text'>
                                        Facilisis pellentesque quis accumsan
                                        ultricies. Eu egestas eget feugiat
                                        lacus, amet, sollicitudin egestas
                                        laoreet etiam.{' '}
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div className='studying-process__list-text'>
                                        Eget amet, enim pharetra leo egestas
                                        nisi, odio imperdiet facilisis. Aliquet
                                        orci varius volutpat egestas facilisi
                                        lobortis.{' '}
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div className='studying-process__list-text'>
                                        Non tempor pulvinar tincidunt aliquam.
                                        Placerat ultricies malesuada dui auctor.
                                    </div>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className='studying-process__right-container'>
                            <img
                                ...
                                alt='studyingIllustration'
                            />
                        </div>
                    </div>

                    <div className='all-team'>
                        <h6 className='all-team__subtitle subtitle'>
                        ...
                        <div className='all-team__cards'>
                            ...
                            <div className='all-team__card slide'>
                                ...
                                <div className='slide__info'>
                                    ...
                                    <p className='slide__job-title'>
                                        Curator of HR & Recruting Course
                                    </p>
                                </div>
                            </div>
                            <div className='all-team__card slide'>
                            ...
                            <div className='all-team__card slide'>
                                ...
                                <div className='slide__info'>
                                    ...
                                    <p className='slide__job-title'>
                                        UX Designer, Curator of Design Course
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div className='best-jobs-bg'>
                    <div className='wrapper'>
                        <div className='best-jobs'>
                            <div className='best-jobs__subtitle subtitle'>
                                best jobs for you
                            </div>
                            <div className='best-jobs__title title'>
