...
export const Events = () => {
    ...
    const [colorSwtichButtonList, setColorSwtichButtonList] = useState({
        color: 'FF3F3A',
        flag: true,
    })
    const [colorSwtichButtonGrid, setColorSwtichButtonGrid] = useState({
        color: '424551',
        flag: false,
    })
        ...
        <>
            ...
            <div className='wrapper'>
                <div className='events-page'>
                    <h6 className='events-page__subtitle subtitle'>
                        Our events
                    </h6>
                    <h1 className='events-page__title title'>
                    ...
                    <div className='events-page__toolbar toolbar'>
                        ...
                        <input
                            className='toolbar__search-event'
                            type='text'
                            placeholder='Search event...'
                        />
                        <div className='toolbar__change-view'>
                            <svg
                                onClick={() => switchDisplayEvents('list')}
                                width='20'
                                height='20'
                                viewBox='0 0 20 20'
                                fill='none'
                            ...
                            >
                                <g clipPath='url(#clip0_2313_4736)'>
                                    <path
                                        ...
                                        fill={`#${colorSwtichButtonList.color}`}
                                    />
                                    <path
                                        fillRule='evenodd'
                                        clipRule='evenodd'
                            ...
                            <svg
                                onClick={() => switchDisplayEvents('grid')}
                                width='20'
                                height='20'
                                viewBox='0 0 20 20'
                                fill='none'
                            ...
                            >
                                <g clipPath='url(#clip0_2313_4737)'>
                                    <path
                                        ...
                                        fill={`#${colorSwtichButtonGrid.color}`}
                                    />
                                    <path
                                        fillRule='evenodd'
                                        clipRule='evenodd'
                    ...
                    <div
                        className={`events-page__events ${
                            colorSwtichButtonGrid.flag ? 'dflex' : ''
                        }`}
                    >
                        {eventsList.map((item, index) => {
                            ...
                            return (
                                <div
                                    className={`events-page__event ${switchEventStyle}`}
                                    key={index + item}
                                >
                                    <div
                                        className={`${switchEventStyle}__date`}
                                    >
                                        <span className='date-number'>
                                            {eventDateNumber}
                                        </span>
                                        <div className='date-month'>
                                            <span>{eventMonthName}</span>
                                    ...
                                    <div
                                        className={`${switchEventStyle}__name`}
                                    >
                                        <p>{eventText}</p>
                                        <p>{eventDescr}</p>
                                    </div>
                                    <button
                                        className={`${switchEventStyle}__button ${switchEventStyle}__button_active button-basic outline regular`}
                                    >
                                        View more
                                    </button>
                                </div>
