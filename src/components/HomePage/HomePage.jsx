                    ...
                    <div className='about'>
                        ...
                        <div className='about__about-us'>
                            ...
                            <ul className='about__list'>
                                ...
                                <li>
                                    <a>
                                        Vulputate placerat amet pulvinar lorem
                                        nisl.
                                    </a>
                                </li>
                                <li>
                                    <a>
                                        Consequat feugiat habitant gravida
                                ...
                                <li>
                                    <a>
                                        ...
                                        purus vulputate dapibus tortor.
                                    </a>
                                </li>
                            </ul>
                        ...
                        <div className='featured__courses main-courses'>
                            ...
                            <div className='featured__course course'>
                                ...
                                <div className='course-content'>
                                    ...
                                    <div className='featured__price-and-teacher price-and-teacher'>
                                        <span>$200</span> | by Leslie Alexander
                                        Li
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className='benefits__info'>
                            <div className='benefits__description'>
                                ...
                                <p>
                                    ...
                                    lobortis mi non fames dictum suspendisse.
                                    Morbi mauris cras massa ut dolor quis sociis
                                    mollis augue. Nunc, sodales tortor sit diam
                                    mi amet massa. Fermentum diam diam sociis
                                    vestibulum. Nulla nisl accumsan, id
                                    dignissim massa ut amet. Amet enim, nisi
                                    tempus vehicula.
                                </p>
                            </div>
                    ...
                    <div className='wrapper'>
                        <div className='homepage-events'>
                            ...
                            <div className='homepage__event event-horizontal'>
                                ...
                                <div className='event-horizontal__name'>
                                    <p>
                                        ...
                                        structure of the company in the face of
                                        uncertainty.
                                    </p>
                            ...
                            <div className='homepage__event event-horizontal'>
                                ...
                                <div className='event-horizontal__name'>
                                    <p>
                                        How to apply methods of speculative
                                        design in practice. Worldbuilding
                                        prototyping.
                                    </p>
                                    <p>Onine workshop</p>
                                </div>
