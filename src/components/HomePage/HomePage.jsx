...
import {
    ...
    girl,
    hover,
    illustrationBenefints,
    homepageMainIllustration,
} from '../../images/images'
            ...
            <div className='wrapper'>
                <div className='about'>
                    <div className='about__image'>
                        <img src={girl} alt='about' width='705' height='560' />
                    </div>
                    <div className='about__about-us'>
                        <h6 className='about__subtitle subtitle'>who we are</h6>
                        <h2 className='about__title title'>Why Createx?</h2>
                        <ul className='about__list'>
                            <li>
                                <a>
                                    A fermentum in morbi pretium aliquam
                            ...
                            <li>
                                <a>
                                    Consequat feugiat habitant gravida quisque
                                    elit bibendum id adipiscing sed.
                                </a>
                            </li>
                            <li>
                                <a>
                            ...
                            <li>
                                <a>
                                    Ultricies amet justo et eget quisque purus
                                    vulputate dapibus tortor.
                                </a>
                            </li>
                        </ul>
                        <button className='button-basic solid regular'>
                            More about us
                        </button>
                    </div>
                </div>
                    ...
                    <div className='featured__courses main-courses'>
                        <div className='featured__course course'>
                            ...
                            <div className='course-content'>
                                <span className='featured__spec spec spec_green'>
                                    Marketing
                                </span>
                        ...
                        <div className='featured__course course'>
                            ...
                            />
                            <div className='course-content'>
                                <span className='featured__spec spec spec_blue'>
                                    Management
                                </span>
                                <h4 className='featured__course-title'>
                        ...
                        <div className='featured__course course'>
                            ...
                            />
                            <div className='course-content'>
                                <span className='featured__spec spec spec_orange'>
                                    HR & Recruting
                                </span>
                                <h4 className='featured__course-title'>
                        ...
                        <div className='featured__course course'>
                            ...
                            />
                            <div className='course-content'>
                                <span className='featured__spec spec spec_red'>
                                    Design
                                </span>
                                <h4 className='featured__course-title'>
                ...
                <div className='benefits'>
                        ...
                        <button className='benefits__button benefits__button_active'>
                            ...
                            >
                                <path
                                    fillRule='evenodd'
                                    clipRule='evenodd'
                                    d='M7.20184 0.736397C7.38953 0.642555 7.61044 0.642555 7.79813 0.736397L14.4648 4.06973C14.6906 4.18266 14.8333 4.4135 14.8333 4.66602C14.8333 4.91853 14.6906 5.14937 14.4648 5.2623L7.79813 8.59563C7.61044 8.68948 7.38953 8.68948 7.20184 8.59563L0.535174 5.2623C0.309318 5.14937 0.16665 4.91853 0.16665 4.66602C0.16665 4.4135 0.309318 4.18266 0.535174 4.06973L7.20184 0.736397ZM2.32403 4.66602L7.49998 7.25399L12.6759 4.66602L7.49998 2.07804L2.32403 4.66602Z'
                                    fill='#9A9CA5'
                                />
                                <path
                                    fillRule='evenodd'
                                    clipRule='evenodd'
                                    d='M0.237032 7.70121C0.401691 7.37189 0.80214 7.2384 1.13146 7.40306L7.49998 10.5873L13.8685 7.40306C14.1978 7.2384 14.5983 7.37189 14.7629 7.70121C14.9276 8.03052 14.7941 8.43097 14.4648 8.59563L7.79813 11.929C7.61044 12.0228 7.38953 12.0228 7.20184 11.929L0.535174 8.59563C0.205855 8.43097 0.0723723 8.03052 0.237032 7.70121Z'
                                    fill='#9A9CA5'
                                />
                                <path
                                    fillRule='evenodd'
                                    clipRule='evenodd'
                                    d='M0.237032 11.0345C0.401691 10.7052 0.80214 10.5717 1.13146 10.7364L7.49998 13.9207L13.8685 10.7364C14.1978 10.5717 14.5983 10.7052 14.7629 11.0345C14.9276 11.3639 14.7941 11.7643 14.4648 11.929L7.79813 15.2623C7.61044 15.3561 7.38953 15.3561 7.20184 15.2623L0.535174 11.929C0.205855 11.7643 0.0723723 11.3639 0.237032 11.0345Z'
                                    fill='#9A9CA5'
                                />
                            </svg>
                            24/7 Online Library
                    ...
                    <div className='benefits__info'>
                        <div className='benefits__description'>
                            ...
                            <p>
                                Urna nisi, arcu cras nunc. Aenean quam est
                                lobortis mi non fames dictum suspendisse. Morbi
                                mauris cras massa ut dolor quis sociis mollis
                                augue. Nunc, sodales tortor sit diam mi amet
                                massa. Fermentum diam diam sociis vestibulum.
                    ...
                    <div className='homepage-events'>
                        ...
                        <div className='homepage__event event-horizontal'>
                            ...
                            <div className='event-horizontal__name'>
                                <p>
                                    Formation of the organizational structure of
                                    the company in the face of uncertainty.
                                </p>
                        ...
                        <div className='homepage__event event-horizontal'>
                            ...
                            <div className='event-horizontal__name'>
                                <p>
                                    Building a customer service department. Best
                                    Practices.
                                </p>
                                <p>Onine lecture</p>
                            </div>
                        ...
                        <div className='homepage__event event-horizontal'>
                            ...
                            <div className='event-horizontal__name'>
                                <p>
                                    How to apply methods of speculative design
                                    in practice. Worldbuilding prototyping.
                                </p>
                                <p>Onine workshop</p>
                            </div>
                            <button className='button-basic outline regular'>
                        ...
                        <div className='show-all-events'>
                            <button className='show-all-events__more'>
                                Do you want more?
                            </button>
                            <button className='button-basic solid large'>
                ...
                <div className='wrapper'>
                    <div className='meet-our-team'>
                        ...
                        <div className='flex sb aic'>
                            ...
                            <div className='asfe'>
                                <svg
                                    className='meet-our-team__toLeftArrow'
                                    width='18'
                                    height='12'
                                    viewBox='0 0 18 12'
                                    fill='none'
                                ...
                                <svg
                                    className='meet-our-team__toRightArrow'
                                    width='18'
                                    height='12'
                                    viewBox='0 0 18 12'
                                    fill='none'
                        ...
                        <div className='meet-our-team-slider'>
                            <div
                                className='meet-our-team-slider__container'
